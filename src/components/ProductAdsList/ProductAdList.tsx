...
export const ProductAdList: React.FC<{ title: string, ads: ProductAdItemProps[] }> = ({ title, 
  ads,
}) => {
  return (
    <div className="min-w-[472px] h-fit pl-2 pt-2 pr-4 pb-4 ml-28 border-t-2 border-l-2 border-gray-800 border-r border-b border-gray-300">
